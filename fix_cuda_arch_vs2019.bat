...
echo C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\MSBuild\Microsoft\VC\v160\BuildCustomizations\CUDA 12.8.props
echo.
echo Change: compute_52,sm_52 -^> compute_75,sm_75
echo.

set "PROPS_FILE=C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\MSBuild\Microsoft\VC\v160\BuildCustomizations\CUDA 12.8.props"
